...
def getArguments():
    ...
    parser.add_argument('--manifold', default='lorentz', type=str,
                        choices=["euclidean", "lorentz", "pv", "poincare",
                                 "klein_mlr", "klein_bmlr", "pv_bmlr"],
                        help="Select CNN model manifold.")
    parser.add_argument('--clip_r', default=1.0, type=float,
                        help="Clip radius for hybrid models (Klein/PV BMLR).")
