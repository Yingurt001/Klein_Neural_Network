...
from models.benchmark_models import (HyperbolicCNN, EuclideanCNN, PVHyperbolicCNN, PoincareHyperbolicCNN,
                                     KleinMLRCNN, KleinBMLRCNN, PV_BMLRCNN)
...
def select_model(args):
    ...
    if args.manifold == "lorentz":
    ...
    elif args.manifold == "pv":
        model = PVHyperbolicCNN(num_classes=args.num_classes,
                                length=args.length,
                                model_dim=args.num_channels,
                                fc_dim=args.embedding_dim,
                                num_layers=args.num_layers,
        ...
        model = PoincareHyperbolicCNN(num_classes=args.num_classes,
                                      length=args.length,
                                      model_dim=args.num_channels,
                                      fc_dim=args.embedding_dim,
                                      num_layers=args.num_layers,
                                      learnable_k=args.learnable_k,
                                      k=args.k)
    elif args.manifold == "klein_mlr":
        model = KleinMLRCNN(num_classes=args.num_classes,
                            length=args.length,
                            model_dim=args.num_channels,
                            fc_dim=args.embedding_dim,
                            num_layers=args.num_layers,
                            learnable_k=args.learnable_k,
                            k=args.k,
                            clip_r=getattr(args, 'clip_r', 1.0))
    elif args.manifold == "klein_bmlr":
        model = KleinBMLRCNN(num_classes=args.num_classes,
                             length=args.length,
                             model_dim=args.num_channels,
                             fc_dim=args.embedding_dim,
                             num_layers=args.num_layers,
                             ...
                             k=args.k,
                             clip_r=getattr(args, 'clip_r', 1.0))
    elif args.manifold == "pv_bmlr":
        model = PV_BMLRCNN(num_classes=args.num_classes,
                           length=args.length,
                           model_dim=args.num_channels,
                           fc_dim=args.embedding_dim,
                           num_layers=args.num_layers,
        ...
        raise ValueError("Manifold '{}' not supported.".format(args.manifold))
